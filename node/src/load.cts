...
module.exports = require("@neon-rs/load").proxy({
  platforms: {
    "win32-x64-msvc": () => require("@unimusic/win32-x64-msvc"),
    "darwin-x64": () => require("@unimusic/darwin-x64"),
    "darwin-arm64": () => require("@unimusic/darwin-arm64"),
    "linux-x64-gnu": () => require("@unimusic/linux-x64-gnu"),
    "linux-arm64-gnu": () => require("@unimusic/linux-arm64-gnu"),
  },
